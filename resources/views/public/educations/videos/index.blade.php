                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page" itemscope='itemscope'
                                itemtype='http://data-vocabulary.org/Breadcrumb'><span class="breadcrumb_last"
                                    itemprop='title'><a>Video Edukasi</a></span></li>
                        </ol>
                    </nav>
                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="position-relative">
                                        <div class="w-100 h-100 position-absolute"
                                            ...
                                            <div class="videoWrapper">
                                                <iframe src="https://www.youtube.com/embed/{{ $video->video_id }}" class="card-img-top"></iframe>
                                            </div>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer border-none">
                                        <p class="small text-muted text-truncate m-0">
                                            {{ \Str::limit($video->description, 240) }} ...
                                        </p>
                                    </div>
                                </div>
                            </a>
